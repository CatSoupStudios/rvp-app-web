...
interface Props {
    /** Texto que se muestra cuando no hay posts o falla la API. */
    emptyStateText: string;
    /** Usuario que se muestra en el botón del estado vacío. */
    handle: string;
    /** URL del perfil de Instagram. */
    profileUrl: string;
}

const InstagramGallery = ({ emptyStateText, handle, profileUrl }: Props) => {
